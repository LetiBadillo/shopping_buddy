             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<a href="{{url('/home')}}"><img style="margin-top: -10px !important; padding-top: 0 !important;" height="60px" class="img-responsive" src="{{asset('images/logo.png')}}"</a>
							</div>
								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											<li> 
											<a href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> Cerrar sesión</a> </li>
...
<div class="copyrights">
	 <p>© 2017 Shopping Buddy. All Rights Reserved </p>
</div>	
